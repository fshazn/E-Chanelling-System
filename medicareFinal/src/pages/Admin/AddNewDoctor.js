...
const AddNewDoctor = () => {
    ...
    const onSubmitForm = async (e) => {
        e.preventDefault();
        await axios.post("http://localhost:8081/doctors", doctor)
        alert('A new Doctor has been added successfully')
        navigate(`/admin/specialities/${specializationId}/doctors`)
    };
        ...
        <Grid container justifyContent='center'>
            ...
            <form onSubmit={(e) => onSubmitForm(e)}>
                <Paper style={addDoctorPaper}>
                    <Typography style={addDoctortypography}>Add New Doctor</Typography>
                    <Grid container justifyContent='center'>
                        ...
                        <Stack direction='row' spacing={2} marginTop='20px' container justifyContent="center">
                            ...
                            <Button style={{ backgroundColor: "#e91e63" }} variant='contained' onClick={() => { navigate(`/admin/specialities/${specializationId}/doctors`) }}>Cancel</Button>
                        </Stack>
                    </Grid>
                </Paper>
            </form>
