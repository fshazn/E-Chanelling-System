...
const EditPatient = () => {
    ...
    const onSubmitForm = async (e) => {
        await axios.put(`http://localhost:8081/patients/${patientId}`, patient)
            ...
            <Grid container justifyContent="center" marginTop="3rem">
                <form onSubmit={(e) => onSubmitForm(e)}>
                    <Paper style={{ height: "35rem", width: "50rem" }}>
                        <Typography variant='h5' textAlign="center" marginTop="2rem" fontWeight="bold">Edit Patient Details</Typography>
                        ...
                        <Stack direction='row' spacing={2} marginTop='20px' container justifyContent="center">
                            <Button style={{ backgroundColor: "#e91e63" }} variant='contained' type='submit'>Update</Button>
                            <Button style={{ backgroundColor: "#e91e63" }} variant='contained' onClick={() => { navigate("/admin/patients") }}>Cancel</Button>
                        </Stack>
                    </Paper>
                </form>
            </Grid>
